        ...
        <div class="p-7">
            <form @submit.prevent="saveData">
                <div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div class="w-full">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white" for="color">Color</label>
                        <input
                            class="w-full rounded border border-stroke bg-gray py-3 px-4.5 font-normal text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                            type="text" name="color" id="color" v-model="obj.color">
                    </div>
                    <div class="w-full">
                        <label class="mb-3 block text-sm font-medium text-black dark:text-white" for="color">Color</label>
                        <div class="flex items-center justify-start">
                            <ColorPicker v-model="obj.color_hexadecimal" inputId="cp-hex" format="hex"/>
                        </div>
                    </div>
                </div>
