...
<template>
    <div class="flex items-center space-x-3.5">
        ...
        <button v-if="$attrs.onEditData" @click="handleEditData">
            <div style="" class="icon-container p-2 rounded-full bg-[#817363]">
        ...
        <button v-if="$attrs.onDeleteData" @click="handleDeleteData">
        ...
        <button @click="handleWeight" :disabled="$props.weightValid">
            <div class="icon-container p-2 rounded-full" :class="{
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    ...
                    <path
                        d="M5 20h14a2 2 0 0 0 2-2l-2-10a2 2 0 0 0-2-2h-3a3 3 0 1 0-6 0H7a2 2 0 0 0-2 2L3 18a2 2 0 0 0 2 2z" />
                    <!-- <text x="8" y="15" font-size="3" font-weight="bold" fill="currentColor">KG</text> -->
                </svg>
            </div>
        </button>
        <button>
