...
<template>
    <div class="grid grid-cols-5 gap-8">
        ...
        <div class="col-span-5 xl:col-span-2">
            <CardComponent>
                <DataTable :value="beltshistory" tableStyle="width: 100%" dataKey="id"
                    v-model:expandedRows="expandedRows">
                    <template #header>
                        <div class="flex justify-between">
                            <div></div>
                            <button @click="newBeltHistory"
                                class="inline-flex items-center justify-center gap-2.5 py-1 px-2 text-center font-medium hover:bg-opacity-90 bg-meta-3 text-white rounded-full">Cargar
                                Historial</button>
                        </div>
                    </template>
    ...
    <UpdateBeltHistoryModalFormComponent :isOpen="isModalBeltHistoryOpen" :title="'Historial de Cinturones'"
        :data="modalBeltHistoryData" @close="closeBeltHistoryModal" />
